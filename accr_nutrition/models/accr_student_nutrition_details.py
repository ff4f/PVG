...
class accrStudentNutritionDetails(models.Model):
    ...
    name = fields.Char(related=u'student.display_name', string='Name', readonly=True, )
    age = fields.Integer(related=u'student.x_studio_age', string="Age", readonly=True, )
    diagnosis = fields.Text(related=u'student.x_studio_diagnosis', string='Diagnosis', readonly=True, )
    residential_section = fields.Many2one(related=u'student.x_studio_residential_section', string='Residential Section', readonly=True, )
    medications = fields.One2many(related=u'student.x_studio_field_jm5yW', string='Medications', readonly=True, )
