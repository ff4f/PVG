...
class accrNutritiontNotification(models.Model):
    ...
    notification_domain = fields.Selection(string=u'Notification Type', selection=[('leave_request', 'Leave Request'), ('hospital_visit', 'Hospital Visit'), ('medical_assessment', 'Medical Assessment')], )
