...
class accrNutritionStudent(models.Model):
    ...
    student_residential_section = fields.Many2one(
        related='student.x_studio_residential_sections', string=u'Residential Section', readonly=True, store=False, )
    student_residential_room = fields.Many2one(
        related='student.x_residential_section_room', string=u'Residential Room', readonly=True, store=False, )
    student_residential_supervisor = fields.Many2one(
        related='student_residential_room.x_studio_supervisor', string=u'Residential Supervisor', readonly=True, store=False)
    student_residential_caregiver = fields.Many2one(
        related='student_residential_room.x_studio_caregiver', string=u'Residential Caregiver', readonly=True, store=False)
