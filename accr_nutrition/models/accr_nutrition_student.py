...
class accrNutritionStudent(models.Model):
    ...
    student_medical_investigations = fields.Many2many(related='student.x_studio_field_MSnvc', string='Medical Investigations', store=False, readonly=True, track_visibility='onchange', )
